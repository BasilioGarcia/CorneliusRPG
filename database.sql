...
id              int(255) unsigned auto_increment NOT NULL,
system_id       int(255) unsigned NOT NULL DEFAULT 0,
name            varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CONSTRAINT fk_characters_system FOREIGN KEY(system_id) REFERENCES systems(id),
...
current_character_id int(255) unsigned NOT NULL,
...
CONSTRAINT fk_cu_current_character FOREIGN KEY(current_character_id) REFERENCES characters(id)
)ENGINE=InnoDb DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
